...
科研论文主要可以分为3类：   
在期刊杂志上发表的论文(journal paper)       
在会议上发表的论文( conference paper)   
学位论文(thesis,实际学位论文笔记为：D)   

**摘要**   
摘要主要内容为研究内容和研究过程，包括研究对象、研究途径、研究方法和步骤，简明扼要指出论文的主要成果以及关键数据，并点名研究成果的理论意义与应用价值。
由于摘要类型的差异，内容选择会有侧重。最终内容主要围绕目的、方法、结果以及结果的分析、意义等撰写。     

**关键词**  
关键词是学术论文独有的构成要素。按照国际GB7713-2004标准，关键词应该为中文、英文、数字、符号的组合，长度为1-10个字。   
每篇报告、论文应该提供3-8个关键词，并且提供中英文对等关键词翻译。    

![questProcess.png](assets/questProcess.png)

### 工程伦理教育发展的历程

![ethicsHistory.png](assets/ethicsHistory.jpg)

有利于协调社会各群体的利益关系，确保社会稳定和谐，把公众的健康、安全作为社会发展的基础，引导工程实践中更有效率、更安全的决策。   

## 第五次课
2025年10月19日    

**工程的过程**
一般而言，如下的五个环节构成了工程的完整生命周期。
工程计划：   
包括工程设想提出和决策部分，解决必要性和可行性问题

工程设计：   
包括工程系统的结构、功能、性能、成本等方面的设计。
